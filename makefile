...
import/websites/gr.maharashtra.gov.in/Law:
	cd import/websites/gr.maharashtra.gov.in/ && ln -s $(GR_DIR)/Law .
...
import: check_env import/websites/gr.maharashtra.gov.in/Law .secrets/google.token 
	poetry run python import/src/build_documents.py import/websites/gr.maharashtra.gov.in/Law import/documents
